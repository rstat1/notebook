...
end:/(?=#)|$/,contains:[b,o,r]},{begin:/\b(print|exec)\(/}]}}})());hljs.registerLanguage("c",(()=>{"use strict";return e=>{const t=(e=>{
...
;return t.name="C",t.aliases=["c","h"],t}})());hljs.registerLanguage("vbnet",(()=>{"use strict";return e=>({
...
"meta-keyword":"if else elseif end region externalsource"}}]})})());hljs.registerLanguage("makefile",(()=>{"use strict";return e=>{const i={
...
t.aliases=["cc","c++","h++","hpp","hh","hxx","cxx"],t}})());hljs.registerLanguage("xml",(()=>{"use strict";function e(e){
...
},i,e.QUOTE_STRING_MODE,e.APOS_STRING_MODE,r,e.CSS_NUMBER_MODE]}]}}})());hljs.registerLanguage("php",(()=>{"use strict";return e=>{const r={
className:"variable",
...
relevance:0,end:";",contains:[e.UNDERSCORE_TITLE_MODE]},l,c]}}})());hljs.registerLanguage("json",(()=>{"use strict";return n=>{const e={
...
name:"Plain text",aliases:["text","txt"],disableAutodetect:!0})})());hljs.registerLanguage("lua",(()=>{"use strict";return e=>{
...
},e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE]},b]}}})());hljs.registerLanguage("rust",(()=>{"use strict";return e=>{
